...
class Seq2Seq(Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, beam_size):
        ...
        self.enc_cell = LSTM(input_size=embedding_dim, hidden_size=hidden_dim, batch_first=True)
        self.dec_cell = LSTM(input_size=embedding_dim, hidden_size=hidden_dim, batch_first=True)
        self.fc = Linear(hidden_dim, embedding_dim, bias=False)
